...
12–30s: Scroll to tasks, show the reading → outline → essay → revision chain and the Friday deadline. “Daylight gives every task a range. Then it plays out sixteen hundred possible weeks, inside the hours I actually have.” Open the essay editor; show best3 / likely4.5 / worst7, then close without changes.

30–48s: Back to the comparison. “What if I narrow the essay by thirty percent? Same random draws. One changed assumption.” Show current51% → changed94%, the +42.3 percentage-point result. “This is a simulation, not a promise. The quality tradeoff is still mine.”

48–63s: Switch the schedule from Current to Changed. Show how work moves earlier and remaining room appears. Switch to Add a work block and inspect actual newly computed values; do not script an unverified number. Show Start earlier: prerequisites still apply.

63–78s: Return to scope30. Export replay. If recording an import, import that exact file and show the locally recomputed result. “The plan, assumptions, seed and model version travel together. Nobody has to trust a screenshot.”
