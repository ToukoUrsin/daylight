...
function renderWeek(){const r=view==='baseline'?result.baseline:result.changed,p=view==='baseline'?plan:result.changedPlan;
  ...
  const maxCap=Math.max(...p.capacity,1);
